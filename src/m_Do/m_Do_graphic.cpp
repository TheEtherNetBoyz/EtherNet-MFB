...
void mDoGph_gInf_c::bloom_c::drawShield() {
    ...
    if (enabled) {
        ...
        CopyToTexObj(&tmpTex[Pass0], Pass0, width / 4, height / 4);
        GXLoadTexObj(&tmpTex[Pass0], GX_TEXMAP0);
        ...
        CopyToTexObj(&tmpTex[Pass1], Pass1, width / 8, height / 8);
        GXLoadTexObj(&tmpTex[Pass1], GX_TEXMAP0);
        ...
        GXSetTexCopySrc(0, 0, width / 4, height / 4);
        CopyToTexObj(&tmpTex[Pass2], Pass2, width / 4, height / 4);
        GXLoadTexObj(&tmpTex[Pass2], GX_TEXMAP0);
