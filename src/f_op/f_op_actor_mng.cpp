...
fpc_ProcID fopAcM_createItemForBoss(const cXyz* i_pos, int i_itemNo, int i_roomNo,
    ...
    if (randomizer_IsActive()) {
        ...
        // The built-in randomizer may need to load a replacement resource, so retain its
        // asynchronous player-item path instead of using the generic fast-create path.
